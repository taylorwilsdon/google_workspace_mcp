...
API_ENABLEMENT_LINKS: Dict[str, str] = {
    ...
    "cloudidentity.googleapis.com": "https://console.cloud.google.com/flows/enableapi?apiid=cloudidentity.googleapis.com",
}
...
INTERNAL_SERVICE_TO_API: Dict[str, str] = {
    ...
    "cloudidentity": "cloudidentity.googleapis.com",
}
